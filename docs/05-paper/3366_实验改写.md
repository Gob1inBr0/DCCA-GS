...
**Deep-Blending drjohnson, 30k, λ=0.004, SPA ratio 0.85.** The same cell1/cell2 protocol was run on the 5090. The 4-component SPA baseline reaches 29.3899 dB at 2.0379 MiB after `cd8/rest16` MLP quantization; the 5-component SPA+MiniSplat cell reaches 29.3146 dB at 2.0021 MiB. The raw decoded results are 29.3900 dB / 2.2060 MiB and 29.3151 dB / 2.1704 MiB, respectively. Thus MiniSplat gives **−0.073 dB** at a **−1.8%** payload in drjohnson, with 90,501 vs 89,790 decoded anchors. Both bitstreams pass bit-exact roundtrip verification.

Together with the 4-28 110k result, this means the MiniSplat benefit is not universal: it is positive on playroom, negligible on 4-28, and slightly negative on drjohnson. We therefore report it as a scene-dependent placement mechanism rather than a general claim.
