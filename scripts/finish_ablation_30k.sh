#!/bin/bash
# Wait for the two 30k DB ablation cells, then collect + append to CSV.
set -e
RUNS=/home/fansonglin/data_space/web_scan/runs
L0=$RUNS/db_playroom_i6_30k_h32_l0p002_ablation_i6off.log
L1=$RUNS/db_playroom_i6_30k_h32_l0p002_ablation_i2off.log
...
echo "ABLATION_30K_ALL_DONE $(date)"
python scripts/collect_queue_results.py
echo "ABLATION_30K_COLLECT_DONE $(date)"
