...
NEW_ABSTRACT = (
    ...
    "arithmetic coding, G-PCC geometry) and adds five evaluated components: "
...
NEW_INTRO = [
    ...
    "5. Mini-Splatting depth re-initialization. After anchor growth stops, "
    "visible scene depth is re-projected and the resulting surface points "
    "are used to refresh anchors while the ADMM budget remains pinned at "
    "the pre-densification count. This changes placement without adding "
    "side information. On Deep-Blending playroom (30k, lambda=0.004, "
    "SPA 0.85), it improves PSNR from 30.221 to 30.420 dB at +2.5% payload; "
